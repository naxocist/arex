...
with demo_users as (
  ...
  from (
    values
      ('90000000-0000-4000-8000-000000000001'::uuid, 'farmer.demo@arex.local', 'farmer', 'สมชาย เกษตรกร', '0810001001', 'เพชรบูรณ์'),
      ('90000000-0000-4000-8000-000000000002'::uuid, 'farmer2.demo@arex.local', 'farmer', 'สมหญิง เกษตรกร', '0810001002', 'นครราชสีมา'),
      ('90000000-0000-4000-8000-000000000003'::uuid, 'logistics.demo@arex.local', 'logistics', 'เอกชัย ขนส่ง', '0810002001', 'สระบุรี'),
      ('90000000-0000-4000-8000-000000000004'::uuid, 'factory.demo@arex.local', 'factory', 'วรินทร์ โรงงาน', '0810003001', 'สระบุรี'),
      ('90000000-0000-4000-8000-000000000005'::uuid, 'warehouse.demo@arex.local', 'warehouse', 'มานพ คลังสินค้า', '0810004001', 'ปทุมธานี'),
      ('90000000-0000-4000-8000-000000000006'::uuid, 'executive.demo@arex.local', 'executive', 'ผู้บริหาร AREX', '0810005001', 'กรุงเทพมหานคร')
