...
--           all 5 ledger entry types, admin approval workflow.
...
truncate table
  ...
  public.material_submission_factory_distances,
...
--   c5xxxxxx = farmer1               c6 = farmer2
--   c7xxxxxx = farmer3               c8 = farmer4
--   c9xxxxxx = farmer5
...
--
-- material_submissions statuses covered:
--   submitted (Sub-01), pickup_scheduled (Sub-02), received (Sub-03),
--   delivered (Sub-04), done (Sub-05,06,08,11,12,13,14), cancelled (Sub-07)
--
-- reward_request statuses covered:
--   requested (RR-A01,B01,E02), approved (no active delivery yet),
--   delivery_scheduled (RR-A02,C02), out_for_delivery (RR-A03,D01),
--   done (RR-B02,C01), rejected (RR-A04,E01), cancelled (RR-B03,D02)
-- =========================================================================

-- -----------------------------------------------------------------------
-- material_submissions — all statuses, with inline logistics/factory fields
...
insert into public.material_submissions (
  ...
  pickup_location_text, pickup_lat, pickup_lng, notes, image_url, status,
  -- logistics fields
  ...
  -- factory fields
  factory_profile_id, measured_weight_kg, discrepancy_note,
  factory_confirmed_at, credited_points,
  created_at, updated_at
)
values
  -- Sub-01: submitted (awaiting scheduling)
  ...
  -- Sub-02: pickup_scheduled
  ('10000001-0000-4000-8000-000000000002',
   'c5000000-0000-4000-8000-000000000001',
   'cassava_root', 500.0, 'กิโลกรัม',
   'ต.นาเฉลียง อ.หนองไผ่ จ.เพชรบูรณ์', 16.04905, 101.14966,
   null, null, 'pickup_scheduled',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() + interval '4 hours', now() + interval '8 hours', null, null, null,
   null, null, null, null, null,
   now() - interval '2 days', now() - interval '1 day 20 hours'),

  -- Sub-03: received (logistics picked up)
  ('10000001-0000-4000-8000-000000000003',
   ...
   null, null, 'received',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '3 days 20 hours', now() - interval '3 days 16 hours', null,
   now() - interval '3 days 18 hours', null,
   null, null, null, null, null,
   now() - interval '4 days', now() - interval '3 days 18 hours'),

  -- Sub-04: delivered (at factory, awaiting confirmation)
  ('10000002-0000-4000-8000-000000000004',
   ...
   now() - interval '4 days 22 hours', now() - interval '4 days 12 hours',
   null, null, null, null, null,
   now() - interval '5 days', now() - interval '4 days 12 hours'),

  -- Sub-05: done (factory confirmed, plastic_waste 50kg × 12.5 = 625pts)
  ('10000002-0000-4000-8000-000000000005',
   ...
   null, null, 'done',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '7 days', now() - interval '6 days 20 hours', null,
   now() - interval '6 days 22 hours', now() - interval '6 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 50.0, null,
   now() - interval '6 days', 625,
   now() - interval '7 days', now() - interval '6 days'),

  -- Sub-06: done (rice_straw 1000kg × 1.0 = 1000pts, funds farmer1 rewards)
  ('10000001-0000-4000-8000-000000000006',
   ...
   null, null, 'done',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '14 days', now() - interval '13 days 20 hours', null,
   now() - interval '13 days 22 hours', now() - interval '13 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 1000.0, null,
   now() - interval '12 days', 1000,
   now() - interval '14 days', now() - interval '12 days'),

  -- Sub-07: cancelled (by logistics, from submitted state)
  ('10000002-0000-4000-8000-000000000007',
   'c6000000-0000-4000-8000-000000000001',
   'sugarcane_bagasse', 150.0, 'กิโลกรัม',
   'อ.เมือง จ.นครราชสีมา', 14.97990, 102.09777,
   null, null, 'cancelled',
   'c3000000-0000-4000-8000-000000000001', null, null, null,
   'เกษตรกรไม่อยู่ที่จุดนัดรับ', null, null,
   null, null, null, null, null,
   now() - interval '6 days', now() - interval '6 days'),

  -- Sub-08: done (rice_straw 600kg × 1.0 = 600pts, funds farmer2 rewards)
  ('10000002-0000-4000-8000-000000000008',
   ...
   null, null, 'done',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '20 days', now() - interval '19 days 20 hours', null,
   now() - interval '19 days 22 hours', now() - interval '19 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 600.0, null,
   now() - interval '18 days', 600,
   now() - interval '20 days', now() - interval '18 days'),

  -- Sub-11: done via CMU, rice_straw 30ก้อน × 12.5 = 375kg × 1.0 = 375pts (farmer3)
  ('10000003-0000-4000-8000-000000000011',
   'c7000000-0000-4000-8000-000000000001',
   'rice_straw', 30.0, 'ก้อน',
   'ต.สันทราย อ.สันทราย จ.เชียงใหม่', 18.85100, 99.01800,
   null, null, 'done',
   'c4000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f003',
   now() - interval '8 days', now() - interval '7 days 20 hours', null,
   now() - interval '7 days 18 hours', now() - interval '6 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 375.0, null,
   now() - interval '5 days', 375,
   now() - interval '8 days', now() - interval '5 days'),

  -- Sub-12: done via CMU, orchard_residue 80kg × 3.125 = 250pts (farmer3)
  ('10000003-0000-4000-8000-000000000012',
   ...
   null, null, 'done',
   'c4000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f003',
   now() - interval '6 days', now() - interval '5 days 20 hours', null,
   now() - interval '5 days 18 hours', now() - interval '4 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 80.0, null,
   now() - interval '3 days', 250,
   now() - interval '6 days', now() - interval '3 days'),

  -- Sub-13: done, rice_straw 400kg × 1.0 = 400pts (farmer4)
  ('10000004-0000-4000-8000-000000000013',
   ...
   null, null, 'done',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '10 days', now() - interval '9 days 20 hours', null,
   now() - interval '9 days 22 hours', now() - interval '9 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 400.0, null,
   now() - interval '8 days', 400,
   now() - interval '10 days', now() - interval '8 days'),

  -- Sub-14: done, orchard_residue 60kg × 3.125 = 187pts (farmer5)
  ('10000005-0000-4000-8000-000000000014',
   ...
   null, null, 'done',
   'c3000000-0000-4000-8000-000000000001', '00000000-0000-4000-8000-00000000f001',
   now() - interval '12 days', now() - interval '11 days 20 hours', null,
   now() - interval '11 days 22 hours', now() - interval '11 days 12 hours',
   'c1000000-0000-4000-8000-000000000001', 60.0, null,
   now() - interval '10 days', 187,
   now() - interval '12 days', now() - interval '10 days')

on conflict (id) do nothing;

-- -----------------------------------------------------------------------
-- Reward requests — all statuses, with inline logistics delivery fields
-- -----------------------------------------------------------------------
...
values
  ...
  -- RR-A02: farmer1 delivery_scheduled (แผ่นคลุมดิน)
  ...
  -- RR-A03: farmer1 out_for_delivery (น้ำมันไพโรไลซิส)
  ('30000001-0000-4000-8000-000000000003',
   ...
   now() - interval '4 days 6 hours', now() - interval '5 hours'),

  -- RR-A04: farmer1 rejected (solar, stock reason)
  ...
  -- RR-B02: farmer2 done (แผ่นคลุมดิน, complete flow)
  ...
  -- RR-B03: farmer2 cancelled (by farmer)
  ...
  -- RR-C01: farmer3 done (biodiesel, complete end-to-end, logistics2)
  ...
  -- RR-C02: farmer3 delivery_scheduled (น้ำมันไพโรไลซิส, logistics2)
  ...
  -- RR-D01: farmer4 out_for_delivery (biodiesel, logistics1)
  ('30000004-0000-4000-8000-000000000001',
   ...
   now() - interval '3 days 6 hours', now() - interval '4 hours'),
...
-- -----------------------------------------------------------------------
-- Logistics distances (logistics_to_farmer_distances)
-- reference_type='material_submission' for pickups
-- reference_type='reward_request' for deliveries
-- -----------------------------------------------------------------------
insert into public.logistics_to_farmer_distances
  (logistics_profile_id, reference_type, reference_id, distance_km)
values
  -- logistics1: queue item (Sub-01 awaiting scheduling)
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000001-0000-4000-8000-000000000001', 185.3),

  -- logistics1: active material_submission jobs
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000001-0000-4000-8000-000000000002', 185.3),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000001-0000-4000-8000-000000000003', 185.3),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000002-0000-4000-8000-000000000004', 144.8),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000002-0000-4000-8000-000000000005', 144.8),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000001-0000-4000-8000-000000000006', 185.3),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000002-0000-4000-8000-000000000008', 144.8),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000004-0000-4000-8000-000000000013', 229.6),
  ('c3000000-0000-4000-8000-000000000001','material_submission','10000005-0000-4000-8000-000000000014',  28.4),

  -- logistics2: เชียงใหม่ area
  ('c4000000-0000-4000-8000-000000000001','material_submission','10000003-0000-4000-8000-000000000011', 6.8),
  ('c4000000-0000-4000-8000-000000000001','material_submission','10000003-0000-4000-8000-000000000012', 6.8),

  -- logistics1: reward delivery jobs
  ...
  -- logistics2: reward delivery jobs
...
-- -----------------------------------------------------------------------
-- material_submission_factory_distances (provider-independent)
-- -----------------------------------------------------------------------
insert into public.material_submission_factory_distances
...
--
-- farmer1: +1000 (Sub-06) -25 (RR-A02 reserve) -50 (RR-A03 reserve)
--          -625 (RR-A04 reserve) +625 (RR-A04 release)
--          = 1000 - 25 - 50 - 625 + 625 = 925 available (125 pending RR-A01)
-- farmer2: +600 (Sub-08) +625 (Sub-05) -25 (RR-B02 reserve) -25 (RR-B02 spend)
--          = 1175 available
-- farmer3: +375 (Sub-11) +250 (Sub-12) -125 (RR-C01 reserve) -125 (RR-C01 spend)
--          -50 (RR-C02 reserve) +50 (adjustment) = 375 available
-- farmer4: +400 (Sub-13) -125 (RR-D01 reserve) -50 (RR-D02 reserve) +50 (RR-D02 release)
--          = 275 available
-- farmer5: +187 (Sub-14) -625 (RR-E01 reserve) +625 (RR-E01 release) = 187 available
--          (RR-E02 requested; 125 reserve not yet created in seed)
-- -----------------------------------------------------------------------
...
values
  -- farmer1: Sub-06 intake
  ('50000001-0000-4000-8000-000000000001',
   'c5000000-0000-4000-8000-000000000001',
   'intake_credit', 1000, 'material_submission', '10000001-0000-4000-8000-000000000006',
   'น้ำหนักจริง 1,000 กก. × 1.0 pt/kg', now() - interval '12 days'),

  -- farmer1: RR-A02 reserve แผ่นคลุมดิน
  ...
  -- farmer1: RR-A03 reserve น้ำมันไพโรไลซิส
  ...
  -- farmer1: RR-A04 reserve solar (rejected → release)
  ...
  -- farmer2: Sub-05 intake (plastic_waste 50kg × 12.5 = 625pts)
  ('50000002-0000-4000-8000-000000000000',
   'c6000000-0000-4000-8000-000000000001',
   'intake_credit', 625, 'material_submission', '10000002-0000-4000-8000-000000000005',
   'น้ำหนักจริง 50 กก. × 12.5 pt/kg', now() - interval '6 days'),

  -- farmer2: Sub-08 intake
  ('50000002-0000-4000-8000-000000000001',
   'c6000000-0000-4000-8000-000000000001',
   'intake_credit', 600, 'material_submission', '10000002-0000-4000-8000-000000000008',
   'น้ำหนักจริง 600 กก. × 1.0 pt/kg', now() - interval '18 days'),

  -- farmer2: RR-B02 reserve + spend (delivered)
  ...
  -- farmer3: Sub-11 intake
  ('50000003-0000-4000-8000-000000000001',
   'c7000000-0000-4000-8000-000000000001',
   'intake_credit', 375, 'material_submission', '10000003-0000-4000-8000-000000000011',
   'น้ำหนักจริง 375 กก. × 1.0 pt/kg', now() - interval '5 days'),

  -- farmer3: Sub-12 intake
  ('50000003-0000-4000-8000-000000000002',
   'c7000000-0000-4000-8000-000000000001',
   'intake_credit', 250, 'material_submission', '10000003-0000-4000-8000-000000000012',
   'น้ำหนักจริง 80 กก. × 3.125 pt/kg', now() - interval '3 days'),

  -- farmer3: RR-C01 reserve + spend (done)
  ...
  -- farmer3: RR-C02 reserve น้ำมันไพโรไลซิส
  ...
  -- farmer3: adjustment (goodwill +50 pts)
  ...
  -- farmer4: Sub-13 intake
  ('50000004-0000-4000-8000-000000000001',
   'c8000000-0000-4000-8000-000000000001',
   'intake_credit', 400, 'material_submission', '10000004-0000-4000-8000-000000000013',
   'น้ำหนักจริง 400 กก. × 1.0 pt/kg', now() - interval '8 days'),

  -- farmer4: RR-D01 reserve (out_for_delivery)
  ...
  -- farmer4: RR-D02 reserve + release (cancelled by farmer)
  ...
  -- farmer5: Sub-14 intake (60 kg × 3.125 = 187 pts)
  ('50000005-0000-4000-8000-000000000001',
   'c9000000-0000-4000-8000-000000000001',
   'intake_credit', 187, 'material_submission', '10000005-0000-4000-8000-000000000014',
   'น้ำหนักจริง 60 กก. × 3.125 pt/kg', now() - interval '10 days'),

  -- farmer5: RR-E01 reserve + release (rejected)
